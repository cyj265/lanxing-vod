...
import com.cyj265.lanxingvod.databinding.DialogSubtitleBinding;
...
public final class SubtitleDialog extends BaseDialog {
    ...
    private void onUp(View view) {
        float position = Setting.getSubtitlePosition() + 0.005f;
    ...
    private void onLarge(View view) {
        float textSize = Setting.getSubtitleTextSize() + 0.002f;
        Setting.putSubtitleTextSize(textSize);
        subtitleView.setFractionalTextSize(textSize);
    }

    private void onSmall(View view) {
        float textSize = Setting.getSubtitleTextSize() - 0.002f;
        if (textSize < 0f) textSize = 0f;
        Setting.putSubtitleTextSize(textSize);
        subtitleView.setFractionalTextSize(textSize);
    }
